...
public class TwoLinkBinTreeTest {
	public static void main(String[] args)
	{
		...
		TwoLinkBinTree.TreeNode tn3 = binTree.addNode(binTree.root(), "第三层左节点", true);
		TwoLinkBinTree.TreeNode tn4 = binTree.addNode(binTree.root(), "第三层左节点", false);
		TwoLinkBinTree.TreeNode tn5 = binTree.addNode(binTree.root(), "第四层左节点", true);
